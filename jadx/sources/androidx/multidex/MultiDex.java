...
public final class MultiDex {
    ...
    public static void install(Context context) {
        ...
        if (IS_VM_MULTIDEX_CAPABLE) {
            ...
            throw new RuntimeException("MultiDex installation failed. SDK " + Build.VERSION.SDK_INT + " is unsupported. Min SDK version is 4" + MobeixUtils.TAG_DOT);
        } else {
            try {
    ...
    public static void installInstrumentation(Context context, Context context2) {
        ...
        if (IS_VM_MULTIDEX_CAPABLE) {
            ...
            try {
                ...
                String str = context.getPackageName() + MobeixUtils.TAG_DOT;
