    ...
    */
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & MobeixUtils.GAUGE_ANIMATION_DURATION) != (configuration2.screenLayout & MobeixUtils.GAUGE_ANIMATION_DURATION)) {
                configuration3.screenLayout |= configuration2.screenLayout & MobeixUtils.GAUGE_ANIMATION_DURATION;
            }
