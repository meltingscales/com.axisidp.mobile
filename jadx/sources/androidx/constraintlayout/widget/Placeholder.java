...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.setARGB(255, MobeixUtils.GAUGE_SEGMENT_TEXT_PROPORTION, MobeixUtils.GAUGE_SEGMENT_TEXT_PROPORTION, MobeixUtils.GAUGE_SEGMENT_TEXT_PROPORTION);
            ...
            paint.getTextBounds(MobeixUtils.TAG_QUESTION_MARK, 0, 1, rect);
            canvas.drawText(MobeixUtils.TAG_QUESTION_MARK, ((width / 2.0f) - (rect.width() / 2.0f)) - rect.left, ((height / 2.0f) + (rect.height() / 2.0f)) - rect.bottom, paint);
        }
    }
