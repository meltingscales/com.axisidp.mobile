...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = MobeixUtils.LIST_ARROW_LEFT;
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, MobeixUtils.LIST_ARROW_LEFT);
            return (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(MobeixUtils.LIST_ARROW_LEFT)) ? false : true;
            ...
            if (keyCode == 19) {
                ...
                if (!keyEvent.isAltPressed()) {
                    return arrowScroll(MobeixUtils.LIST_ARROW_LEFT);
                }
                return fullScroll(MobeixUtils.LIST_ARROW_LEFT);
            } else if (keyCode != 62) {
                return false;
            } else {
