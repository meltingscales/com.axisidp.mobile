...
public final class LocaleListCompat {
    ...
    public static Locale forLanguageTagCompat(String str) {
        if (str.contains(MobeixUtils.TAG_DASH)) {
            String[] split = str.split(MobeixUtils.TAG_DASH, -1);
            if (split.length > 2) {
        ...
        } else if (str.contains(MobeixUtils.TAG_UNDERSCORE)) {
            String[] split2 = str.split(MobeixUtils.TAG_UNDERSCORE, -1);
            if (split2.length > 2) {
