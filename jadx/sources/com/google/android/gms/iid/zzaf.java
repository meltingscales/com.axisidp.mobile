...
public class zzaf {
    ...
    public static String zzi(Bundle bundle) throws IOException {
        ...
        String string = bundle.getString(MobeixUtils.PROPERTY_REG_ID);
        if (string == null) {
            string = bundle.getString("unregistered");
        }
        if (string == null) {
            String string2 = bundle.getString(MobeixUtils.ERROR);
            if (string2 != null) {
    ...
    public final void zzh(Intent intent) {
        ...
        String stringExtra = intent.getStringExtra(MobeixUtils.PROPERTY_REG_ID);
        if (stringExtra == null) {
            stringExtra = intent.getStringExtra("unregistered");
        }
        if (stringExtra == null) {
            String stringExtra2 = intent.getStringExtra(MobeixUtils.ERROR);
            ...
            if (stringExtra2.startsWith("|")) {
                ...
                if (split.length > 2) {
                    String str3 = split[2];
                    str = split[3];
                    if (str.startsWith(MobeixUtils.SPLITTER_COLLON)) {
                        str = str.substring(1);
                    }
                    str2 = str3;
                } else {
                ...
                stringExtra2 = str;
                intent.putExtra(MobeixUtils.ERROR, stringExtra2);
            }
            if (str2 == null) {
                synchronized (getClass()) {
        ...
        extras.putString(MobeixUtils.PROPERTY_REG_ID, group2);
