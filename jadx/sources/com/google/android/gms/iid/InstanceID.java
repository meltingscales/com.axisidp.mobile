...
public class InstanceID {
    ...
    public String getToken(String str, String str2, Bundle bundle) throws IOException {
        ...
        String str3 = zzbx.get(MobeixUtils.PROPERTY_APP_VERSION);
        boolean z = true;
        ...
        if (zzf == null) {
            ...
            if (zzbu.get().booleanValue() && zze.contains(MobeixUtils.SPLITTER_COLLON) && !zze.startsWith(String.valueOf(getId()).concat(MobeixUtils.SPLITTER_COLLON))) {
