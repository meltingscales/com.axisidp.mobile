...
public class GoogleCloudMessaging {
    ...
    public final boolean zzd(Intent intent) {
        ...
        if (stringExtra == null && intent.hasExtra(MobeixUtils.ERROR)) {
    ...
    private final synchronized String zzd(boolean z, String... strArr) throws IOException {
        ...
        String stringExtra = zzd.getStringExtra(MobeixUtils.PROPERTY_REG_ID);
        if (stringExtra != null) {
            return stringExtra;
        }
        String stringExtra2 = zzd.getStringExtra(MobeixUtils.ERROR);
