...
public final class zak extends zap {
    ...
    public final void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        for (int i = 0; i < this.zad.size(); i++) {
            ...
            if (zai != null) {
                ...
                printWriter.println(MobeixUtils.SPLITTER_COLLON);
    ...
    public final void onStart() {
        ...
        Log.d("AutoManageHelper", "onStart " + z + MobeixUtils.TAG_SPACE + valueOf);
    ...
    public final void zad(int i, GoogleApiClient googleApiClient, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        Log.d("AutoManageHelper", "starting AutoManage for client " + i + MobeixUtils.TAG_SPACE + z2 + MobeixUtils.TAG_SPACE + valueOf);
