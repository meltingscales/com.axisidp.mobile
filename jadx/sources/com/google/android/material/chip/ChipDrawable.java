...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    private void drawDebug(Canvas canvas, Rect rect) {
        ...
        if (paint != null) {
            paint.setColor(ColorUtils.setAlphaComponent(-16777216, MobeixUtils.FILLED_IMAGE));
            ...
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-65536, MobeixUtils.FILLED_IMAGE));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-16711936, MobeixUtils.FILLED_IMAGE));
