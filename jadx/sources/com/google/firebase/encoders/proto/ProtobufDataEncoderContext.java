...
public final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private void writeVarInt32(int i) throws IOException {
        while ((i & (-128)) != 0) {
            this.output.write((i & MobeixUtils.FILLED_IMAGE) | 128);
            i >>>= 7;
        }
        this.output.write(i & MobeixUtils.FILLED_IMAGE);
    }

    private void writeVarInt64(long j) throws IOException {
        while (((-128) & j) != 0) {
            this.output.write((((int) j) & MobeixUtils.FILLED_IMAGE) | 128);
            j >>>= 7;
        }
        this.output.write(((int) j) & MobeixUtils.FILLED_IMAGE);
    }
}
