...
public class FileStore {
    ...
    public FileStore(Context context) {
        ...
        this.sessionsDir = prepareBaseDir(new File(this.rootDir, SESSIONS_PATH));
        this.reportsDir = prepareBaseDir(new File(this.rootDir, REPORTS_PATH));
        this.priorityReportsDir = prepareBaseDir(new File(this.rootDir, PRIORITY_REPORTS_PATH));
        this.nativeReportsDir = prepareBaseDir(new File(this.rootDir, NATIVE_REPORTS_PATH));
    }
