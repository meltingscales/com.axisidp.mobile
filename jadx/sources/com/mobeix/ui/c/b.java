...
import com.mobeix.ui.c.c.g;
import com.mobeix.ui.c.c.h;
...
public final class b extends LinearLayout implements ab {
    ...
    public b(Context context, String str, int i, String str2) {
        ...
        try {
            ...
            new StringBuilder(G.a(292)).append(e);
        }
        try {
            ...
            com.mobeix.ui.c.b.c cVar = new com.mobeix.ui.c.b.c(this.d);
            this.c = cVar;
    ...
    private void a() {
        try {
            ...
            if (arrayList != null) {
                ...
                for (int i = 0; i < this.b.size(); i++) {
                    ...
                    if (arrayList4 != null) {
                        for (int i2 = 0; i2 < arrayList4.size(); i2++) {
                            arrayList2.add(new i(i2, arrayList4.get(i2).b, i * arrayList4.get(i2).b * 0.3f, arrayList4.get(i2).b * 0.8f));
                            try {
                ...
                h hVar = new h(arrayList2, "Candle Stick Chart");
                hVar.a(arrayList3);
                hVar.a(Color.rgb(244, 0, 0));
                ArrayList arrayList5 = new ArrayList();
                arrayList5.add(hVar);
                this.c.setData(new g(this.a.b, arrayList5));
                ...
                this.c.setMarkerView(new f(this.d.getApplicationContext(), textView) { // from class: com.mobeix.ui.c.b.1
                    @Override // com.mobeix.ui.c.g.f
                    public final void a(com.mobeix.ui.c.c.l lVar, int i3) {
                        StringBuilder sb = new StringBuilder(G.a(118));
                        sb.append(i3);
                        sb.append(" Entry: ");
                        sb.append(lVar);
