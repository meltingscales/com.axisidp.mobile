...
public final class df extends LinearLayout implements ab {
    de a;
    private boolean b;

    public df(Context context, de deVar, LinearLayout.LayoutParams layoutParams) {
        super(context);
        this.a = null;
        try {
            this.a = deVar;
    ...
    public final int getAllignType() {
        return da.aY(this.a.getStyleID()) | da.aX(this.a.getStyleID());
    }
