...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-wide v0, p0, Lcom/facebook/android/Facebook;->accessExpiresMillisecondsAfterEpoch:J

    iput-wide v0, p0, Lcom/facebook/android/Facebook;->lastAccessUpdateMillisecondsAfterEpoch:J
...
.method static synthetic access$0(Lcom/facebook/android/Facebook;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/facebook/android/Facebook;->accessToken:Ljava/lang/String;
...
.method static synthetic access$1(Lcom/facebook/android/Facebook;)Lcom/facebook/Session;
    ...
    iget-object p0, p0, Lcom/facebook/android/Facebook;->session:Lcom/facebook/Session;
...
.method static synthetic access$3(Lcom/facebook/android/Facebook;)[Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/facebook/android/Facebook;->pendingAuthorizationPermissions:[Ljava/lang/String;
...
.method private authorize(Landroid/app/Activity;[Ljava/lang/String;ILcom/facebook/SessionLoginBehavior;Lcom/facebook/android/Facebook$DialogListener;)V
    ...
    new-instance p2, Lcom/facebook/android/Facebook$1;

    invoke-direct {p2, p0, p5}, Lcom/facebook/android/Facebook$1;-><init>(Lcom/facebook/android/Facebook;Lcom/facebook/android/Facebook$DialogListener;)V

    new-instance p5, Lcom/facebook/Session$OpenRequest;

    invoke-direct {p5, p1}, Lcom/facebook/Session$OpenRequest;-><init>(Landroid/app/Activity;)V

    invoke-virtual {p5, p2}, Lcom/facebook/Session$OpenRequest;->setCallback(Lcom/facebook/Session$StatusCallback;)Lcom/facebook/Session$OpenRequest;

    move-result-object p1

    invoke-virtual {p1, p4}, Lcom/facebook/Session$OpenRequest;->setLoginBehavior(Lcom/facebook/SessionLoginBehavior;)Lcom/facebook/Session$OpenRequest;

    move-result-object p1

    invoke-virtual {p1, p3}, Lcom/facebook/Session$OpenRequest;->setRequestCode(I)Lcom/facebook/Session$OpenRequest;

    move-result-object p1

    iget-object p2, p0, Lcom/facebook/android/Facebook;->pendingAuthorizationPermissions:[Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/facebook/android/Facebook;->pendingOpeningSession:Lcom/facebook/Session;

    iget-object p3, p0, Lcom/facebook/android/Facebook;->pendingAuthorizationPermissions:[Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, p2, p1, v0}, Lcom/facebook/android/Facebook;->openSession(Lcom/facebook/Session;Lcom/facebook/Session$OpenRequest;Z)V
...
.method private checkUserSession(Ljava/lang/String;)V
    ...
    const-string p1, "Cannot call %s after setSession has been called."
...
.method private onSessionCallback(Lcom/facebook/Session;Lcom/facebook/SessionState;Ljava/lang/Exception;Lcom/facebook/android/Facebook$DialogListener;)V
    ...
    :try_start_0
    iget-object p3, p0, Lcom/facebook/android/Facebook;->session:Lcom/facebook/Session;

    if-eq p1, p3, :cond_0

    iget-object p2, p0, Lcom/facebook/android/Facebook;->session:Lcom/facebook/Session;

    iput-object p1, p0, Lcom/facebook/android/Facebook;->session:Lcom/facebook/Session;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lcom/facebook/android/Facebook;->sessionInvalidated:Z
    ...
    invoke-virtual {p2}, Lcom/facebook/Session;->close()V
    ...
    :cond_3
    instance-of p1, p3, Lcom/facebook/FacebookAuthorizationException;

    if-eqz p1, :cond_4

    if-eqz v0, :cond_4

    const-string p1, "com.facebook.sdk.WebViewErrorCode"
    ...
    const-string p1, "com.facebook.sdk.FailingUrl"
    ...
    const-string p3, "com.facebook.sdk.WebViewErrorCode"
    ...
    invoke-direct {p1, p2, p3, v0}, Lcom/facebook/android/DialogError;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    invoke-interface {p4, p1}, Lcom/facebook/android/Facebook$DialogListener;->onError(Lcom/facebook/android/DialogError;)V
    ...
    invoke-interface {p4, p1}, Lcom/facebook/android/Facebook$DialogListener;->onFacebookError(Lcom/facebook/android/FacebookError;)V
...
.method private validateServiceIntent(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/facebook/android/Facebook;->validateAppSignatureForPackage(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public authorize(Landroid/app/Activity;Lcom/facebook/android/Facebook$DialogListener;)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/facebook/android/Facebook;->authorize(Landroid/app/Activity;[Ljava/lang/String;ILcom/facebook/SessionLoginBehavior;Lcom/facebook/android/Facebook$DialogListener;)V
...
.method public authorizeCallback(IILandroid/content/Intent;)V
    ...
    iput-object p1, p0, Lcom/facebook/android/Facebook;->pendingOpeningSession:Lcom/facebook/Session;
...
.method public dialog(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Lcom/facebook/android/Facebook$DialogListener;)V
    ...
    invoke-static {p1, p2, p3}, Lcom/facebook/android/Util;->showAlert(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final getSession()Lcom/facebook/Session;
    ...
    invoke-direct {p0, v2, v3, v1}, Lcom/facebook/android/Facebook;->openSession(Lcom/facebook/Session;Lcom/facebook/Session$OpenRequest;Z)V
...
.method logoutImpl(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/facebook/android/Facebook;->checkUserSession(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/facebook/android/Facebook;->request(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    iput-object v4, p0, Lcom/facebook/android/Facebook;->session:Lcom/facebook/Session;

    iput-object v4, p0, Lcom/facebook/android/Facebook;->accessToken:Ljava/lang/String;

    const-wide/16 v4, 0x0

    iput-wide v4, p0, Lcom/facebook/android/Facebook;->accessExpiresMillisecondsAfterEpoch:J
...
.method requestImpl(Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    sget-object p1, Lcom/facebook/android/Facebook;->RESTSERVER_URL:Ljava/lang/String;

    :goto_0
    invoke-static {p1, p3, p2}, Lcom/facebook/android/Util;->openUrl(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
